...
HD_PWD='C:/Users/CSE.CAL/Desktop/MS3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Digit_Seven_Segment_Driver_Optimized.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_Digit_Seven_Segment_Driver_Optimized.tcl -notrace
