...
HD_PWD='C:/Users/CSE.CAL/Desktop/MS3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Digit_Seven_Segment_Driver_Optimized.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Four_Digit_Seven_Segment_Driver_Optimized.tcl
